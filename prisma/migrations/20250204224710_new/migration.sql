/*
  ...
  - You are about to drop the `MonthlyFinancial` table. If the table is not empty, all the data it contains will be lost.
...
CREATE TABLE "Sales" (
    ...
    "catering" DOUBLE PRECISION NOT NULL,
    "doordash" DOUBLE PRECISION NOT NULL,
